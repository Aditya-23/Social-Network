...
const mapStateToProps = state => {
    return {auth: state.auth, profile: state.profileReducer.profile, alert: state.alertReducer}
};

export default connect(mapStateToProps, {createProfile, removeAlert})(EditProfile);